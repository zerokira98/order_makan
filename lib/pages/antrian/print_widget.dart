...
class PrintWidgetSetting extends StatefulWidget {
  const PrintWidgetSetting({super.key});

  @override
  State<PrintWidgetSetting> createState() => _PrintWidgetSettingState();
}

class _PrintWidgetSettingState extends State<PrintWidgetSetting> {
  String _info = "";
  String _msj = '';
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                final bool result = await PrintBluetoothThermal
                                    .connectionStatus;
                                connected = result;
                                setState(() {
                                  _info = "connection status: $result";
